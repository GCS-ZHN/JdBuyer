...
修改项目主文件 `shopping_cart.json`，为每个商品添加对应的商品skuid，下单地址areaid，开始抢购时间buytime（如果需要）。可以自行增加商品数。
```json
{
    "goods": [
        {
            "skuid": "100012957754",
            "areaid": "15_1213_71707_71733",
            "count": 1,
            "remark": "KOOGIS可其氏免洗洗手液免洗手消毒凝胶75%酒精消毒液抑菌速干60ml*6瓶"
        },
        {
            "skuid": "7943666",
            "areaid": "15_1213_71707_71733",
            "count": 1,
            "buytime": "2022-12-20 17:42:00",
            "remark": "南极人10双抑菌新疆棉袜子男士袜子秋冬款篮球运动袜透气长袜休闲男袜潮袜男士棉袜中筒袜 纯色款"
        }
    ]
}
```
